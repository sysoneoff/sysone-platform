...
async function readJson(response: Response) {
  ...
  if (!response.ok) {
    throw new Error(
      data.error || `request_failed_${response.status}`,
    );
  }
  ...
  const filtered = useMemo(
    () =>
      products.filter((product) => {
        ...
        const haystack =
          `${product.name} ${product.slug} ${product.category ?? ""}`.toLowerCase();
...
function MediaManager() {
  ...
  async function remove(
    ...
    try {
      await readJson(
        await fetch(
          `/api/admin/media?key=${encodeURIComponent(asset.key)}`,
          {
            method:
              "DELETE",
          },
    ...
    <section className="adminWorkspace">
      <div className="adminWorkspaceHead">
        <div>
          ...
          <p>
            Private R2 bucket ichida
            saqlanadigan public product
            media.
          </p>
        </div>
...
function ModulePlaceholder({
  ...
  return (
    <section className="adminModulePlaceholder">
      ...
      <p>
        Bu modul master arxitekturada
        mavjud. Keyingi bosqichlarda
        D1, R2, KV, permissions va
        audit workflow bilan real
        ishlashga ulanadi.
      </p>
      ...
      <div className="placeholderActions">
        ...
        <button className="button buttonGhost">
          View roadmap
        </button>
      </div>
    </section>
        ...
        <main className="controlMain">
          <header className="controlTop">
            ...
            <div className="controlTopActions">
              <button className="controlTopIcon">
                <Search />
              </button>
          ...
          <div className="adminNotice">
            ...
            <span>
              ...
              Cloudflare secret sifatida
              saqlanadi; session HttpOnly
              cookie bilan imzolanadi.
            </span>
          </div>
